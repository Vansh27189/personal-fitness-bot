Here’s a tailored version of your project description adapted for a **Fitness Virtual Assistant Bot** that delivers personalized fitness plans based on the user's goal (lose or gain weight):
